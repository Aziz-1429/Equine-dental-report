 ...
 */
export function Tooth({ region, finding, selected, onSelect }: ToothProps) {
    ...
    >
      ...
      <polygon
        ...
        className={[
          ...
          isUntouched ? 'fill-transparent hover:fill-primary/10' : `${status.fillClassName} fill-opacity-55`,
